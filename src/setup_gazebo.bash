...
export GAZEBO_PLUGIN_PATH=$GAZEBO_PLUGIN_PATH:$(pwd)/build_gazebo
export GAZEBO_MODEL_PATH=$GAZEBO_MODEL_PATH:$(pwd)/src/sitl_gazebo/models
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$(pwd)/build_gazebo
