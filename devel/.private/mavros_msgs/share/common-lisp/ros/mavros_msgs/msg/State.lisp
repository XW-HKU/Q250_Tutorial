...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<State>)))
  ...
  (cl:format cl:nil "# Current autopilot state~%#~%# Known modes listed here:~%# http://wiki.ros.org/mavros/CustomModes~%#~%# For system_status values~%# see https://mavlink.io/en/messages/common.html#MAV_STATE~%#~%~%std_msgs/Header header~%bool connected~%bool armed~%bool guided~%string mode~%uint8 system_status~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'State)))
  "Returns full string definition for message of type 'State"
  (cl:format cl:nil "# Current autopilot state~%#~%# Known modes listed here:~%# http://wiki.ros.org/mavros/CustomModes~%#~%# For system_status values~%# see https://mavlink.io/en/messages/common.html#MAV_STATE~%#~%~%std_msgs/Header header~%bool connected~%bool armed~%bool guided~%string mode~%uint8 system_status~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
