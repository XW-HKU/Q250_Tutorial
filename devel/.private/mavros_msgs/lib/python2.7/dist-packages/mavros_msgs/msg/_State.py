...
class State(genpy.Message):
  _md5sum = "63d9a29b6abd9e0beeba06109556d062"
...
string frame_id
"""
  __slots__ = ['header','connected','armed','guided','mode','system_status']
  _slot_types = ['std_msgs/Header','bool','bool','bool','string','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,connected,armed,guided,mode,system_status
