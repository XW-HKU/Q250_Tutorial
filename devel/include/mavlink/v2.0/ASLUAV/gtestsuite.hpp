...
TEST(ASLUAV, SATCOM_LINK_STATUS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ASLUAV::msg::SATCOM_LINK_STATUS packet_in{};
    packet_in.timestamp = 93372036854775807ULL;
    ...
    mavlink::ASLUAV::msg::SATCOM_LINK_STATUS packet1{};
    mavlink::ASLUAV::msg::SATCOM_LINK_STATUS packet2{};
...
#ifdef TEST_INTEROP
TEST(ASLUAV_interop, SATCOM_LINK_STATUS)
{
    mavlink_message_t msg;
    ...
    mavlink_satcom_link_status_t packet_c {
    ...
    mavlink_msg_satcom_link_status_encode(1, 1, &msg, &packet_c);
