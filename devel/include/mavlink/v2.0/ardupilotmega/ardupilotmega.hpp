...
enum class MAV_CMD
{
    ...
    DO_GRIPPER=211, /* Mission command to operate EPM gripper. |1: Gripper number (a number from 1 to max number of grippers on the vehicle).| 2: Gripper action (0=release, 1=grab. See GRIPPER_ACTIONS enum).| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    DO_AUTOTUNE_ENABLE=212, /* Enable/disable autotune. |1: Enable (1: enable, 0:disable).| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    ...
    POWER_OFF_INITIATED=42000, /* A system wide power-off event has been initiated. |1: Empty.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    SOLO_BTN_FLY_CLICK=42001, /* FLY button has been clicked. |1: Empty.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    SOLO_BTN_FLY_HOLD=42002, /* FLY button has been held for 1.5 seconds. |1: Takeoff altitude.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    SOLO_BTN_PAUSE_CLICK=42003, /* PAUSE button has been clicked. |1: 1 if Solo is in a shot mode, 0 otherwise.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    FIXED_MAG_CAL=42004, /* Magnetometer calibration based on fixed position
        in earth field given by inclination, declination and intensity. |1: MagDeclinationDegrees.| 2: MagInclinationDegrees.| 3: MagIntensityMilliGauss.| 4: YawDegrees.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    FIXED_MAG_CAL_FIELD=42005, /* Magnetometer calibration based on fixed expected field values in milliGauss. |1: FieldX.| 2: FieldY.| 3: FieldZ.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    DO_START_MAG_CAL=42424, /* Initiate a magnetometer calibration. |1: uint8_t bitmask of magnetometers (0 means all).| 2: Automatically retry on failure (0=no retry, 1=retry).| 3: quire input, 1=autosave).| 4: Delay (seconds).| 5: Autoreboot (0=user reboot, 1=autoreboot).| 6: Empty.| 7: Empty.|  */
    DO_ACCEPT_MAG_CAL=42425, /* Initiate a magnetometer calibration. |1: uint8_t bitmask of magnetometers (0 means all).| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    DO_CANCEL_MAG_CAL=42426, /* Cancel a running magnetometer calibration. |1: uint8_t bitmask of magnetometers (0 means all).| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    SET_FACTORY_TEST_MODE=42427, /* Command autopilot to get into factory test/diagnostic mode. |1: 0 means get out of test mode, 1 means get into test mode.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    DO_SEND_BANNER=42428, /* Reply with the version banner. |1: Empty.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    ACCELCAL_VEHICLE_POS=42429, /* Used when doing accelerometer calibration. When sent to the GCS tells it what position to put the vehicle in. When sent to the vehicle says what position the vehicle is in. |1: Position, one of the ACCELCAL_VEHICLE_POS enum values.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    GIMBAL_RESET=42501, /* Causes the gimbal to reset and boot as if it was just powered on. |1: Empty.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    GIMBAL_AXIS_CALIBRATION_STATUS=42502, /* Reports progress and success or failure of gimbal axis calibration procedure. |1: Gimbal axis we're reporting calibration progress for.| 2: Current calibration progress for this axis, 0x64=100%.| 3: Status of the calibration.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    GIMBAL_REQUEST_AXIS_CALIBRATION=42503, /* Starts commutation calibration on the gimbal. |1: Empty.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
    GIMBAL_FULL_RESET=42505, /* Erases gimbal application and parameters. |1: Magic number.| 2: Magic number.| 3: Magic number.| 4: Magic number.| 5: Magic number.| 6: Magic number.| 7: Magic number.|  */
    DO_WINCH=42600, /* Command to operate winch. |1: Winch number (0 for the default winch, otherwise a number from 1 to max number of winches on the vehicle).| 2: Action (0=relax, 1=relative length control, 2=rate control. See WINCH_ACTIONS enum.).| 3: Release length (cable distance to unwind in meters, negative numbers to wind in cable).| 4: Release rate (meters/second).| 5: Empty.| 6: Empty.| 7: Empty.|  */
    FLASH_BOOTLOADER=42650, /* Update the bootloader |1: Empty| 2: Empty| 3: Empty| 4: Empty| 5: Magic number - set to 290876 to actually flash| 6: Empty| 7: Empty|  */
};
