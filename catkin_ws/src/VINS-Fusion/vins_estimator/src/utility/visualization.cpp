...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_vins_pose = n.advertise<geometry_msgs::PoseStamped>("vins_pose", 1000);
...
void pubLatestOdometry(const Eigen::Vector3d &P, const Eigen::Quaterniond &Q, const Eigen::Vector3d &V, const Eigen::Vector3d &A, const Eigen::Vector3d &omega, double t)
{
    ...
    //add some changes; fov pose msg
    geometry_msgs::PoseStamped vins_pose;
    vins_pose.header = odometry.header;
    vins_pose.pose = odometry.pose.pose;
    pub_vins_pose.publish(vins_pose);
}
